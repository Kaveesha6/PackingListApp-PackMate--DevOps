...
public class TrainItemAdapter extends RecyclerView.Adapter<TrainItemAdapter.ViewHolder> {
    ...
    private List<TrainItem> itemList;
    private Context context;

    public TrainItemAdapter(Context context, List<TrainItem> itemList) {
    ...
    public void onBindViewHolder(@NonNull ViewHolder holder, int position) {
        TrainItem item = itemList.get(position);
    ...
    public void addItem(TrainItem item) {
        itemList.add(item);
