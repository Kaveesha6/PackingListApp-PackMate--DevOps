...
public class FitnessItemAdapter extends RecyclerView.Adapter<FitnessItemAdapter.ViewHolder> {
    ...
    private List<FitnessItem> itemList;
    private Context context;

    public FitnessItemAdapter(Context context, List<FitnessItem> itemList) {
    ...
    public void onBindViewHolder(@NonNull ViewHolder holder, int position) {
        FitnessItem item = itemList.get(position);
    ...
    public void addItem(FitnessItem item) {
        itemList.add(item);
        notifyItemInserted(itemList.size() - 1);
    }

    public List<FitnessItem> getItemList() {
        return itemList;
    }
