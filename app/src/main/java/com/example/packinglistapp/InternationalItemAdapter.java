...
public class InternationalItemAdapter extends RecyclerView.Adapter<InternationalItemAdapter.ViewHolder> {

    private List<InternationalItem> itemList;
    private Context context;

    public InternationalItemAdapter(Context context, List<InternationalItem> itemList) {
    ...
    public void onBindViewHolder(@NonNull ViewHolder holder, int position) {
        InternationalItem item = itemList.get(position);
