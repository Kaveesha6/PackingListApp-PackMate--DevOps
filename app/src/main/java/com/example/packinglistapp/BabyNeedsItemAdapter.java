...
public class BabyNeedsItemAdapter extends RecyclerView.Adapter<BabyNeedsItemAdapter.ViewHolder> {

    private List<BabyNeedsItem> itemList;
    private Context context;

    public BabyNeedsItemAdapter(Context context, List<BabyNeedsItem> itemList) {
    ...
    public void onBindViewHolder(@NonNull ViewHolder holder, int position) {
        BabyNeedsItem item = itemList.get(position);
    ...
    public void addItem(BabyNeedsItem item) {
        itemList.add(item);
        notifyItemInserted(itemList.size() - 1);
    }

    public List<BabyNeedsItem> getItemList() {
        return itemList;
    }
