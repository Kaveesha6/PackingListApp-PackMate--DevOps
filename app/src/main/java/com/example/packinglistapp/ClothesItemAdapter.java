...
public class ClothesItemAdapter extends RecyclerView.Adapter<ClothesItemAdapter.ViewHolder> {

    private List<ClothesItem> itemList;
    private Context context;

    public ClothesItemAdapter(Context context, List<ClothesItem> itemList) {
    ...
    public List<ClothesItem> getItemList() {
        return itemList;
    }
