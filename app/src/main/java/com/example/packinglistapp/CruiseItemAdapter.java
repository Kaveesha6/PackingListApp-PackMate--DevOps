...
public class CruiseItemAdapter extends RecyclerView.Adapter<CruiseItemAdapter.ViewHolder> {

    private List<CruiseItem> itemList;
    private Context context;

    public CruiseItemAdapter(Context context, List<CruiseItem> itemList) {
    ...
    public void onBindViewHolder(@NonNull ViewHolder holder, int position) {
        CruiseItem item = itemList.get(position);
    ...
    public void addItem(CruiseItem item) {
        itemList.add(item);
        notifyItemInserted(itemList.size() - 1);
    }

    public List<CruiseItem> getItemList() {
        return itemList;
    }
