...
public class RentalItemAdapter extends RecyclerView.Adapter<RentalItemAdapter.ViewHolder> {

    private List<RentalItem> itemList;
    private Context context;

    public RentalItemAdapter(Context context, List<RentalItem> itemList) {
    ...
    public List<RentalItem> getItemList() {
        return itemList;
    }
