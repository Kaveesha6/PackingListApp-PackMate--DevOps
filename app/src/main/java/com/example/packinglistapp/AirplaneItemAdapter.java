...
public class AirplaneItemAdapter extends RecyclerView.Adapter<AirplaneItemAdapter.ViewHolder> {

    private List<AirplaneItem> itemList;
    private Context context;

    public AirplaneItemAdapter(Context context, List<AirplaneItem> itemList) {
    ...
    public void onBindViewHolder(@NonNull ViewHolder holder, int position) {
        AirplaneItem item = itemList.get(position);
    ...
    public void addItem(AirplaneItem item) {
        itemList.add(item);
        notifyItemInserted(itemList.size() - 1);
    }

    public List<AirplaneItem> getItemList() {
        return itemList;
    }
